package de.achimmihca.lineshortcuts.logging;

import org.eclipse.core.runtime.ILog;
import org.eclipse.core.runtime.IStatus;
import org.eclipse.core.runtime.Status;

import de.achimmihca.lineshortcuts.ShortcutsActivator;
...
public class LogWrapper {
	...
	public LogWrapper(Class<?> clazz) {
		if( ShortcutsActivator.getDefault() != null ) {
			log = ShortcutsActivator.getDefault().getLog();
		} else {
	...
	public void info(Exception e, String message, Object... messageVariables) {
		...
		Status status =
		    new Status( IStatus.INFO, ShortcutsActivator.PLUGIN_ID, clazz.getName() + ":" + message, e );
		log.log( status );
	}
	...
	public void warn(Exception e, String message, Object... messageVariables) {
		...
		Status status =
		    new Status( IStatus.WARNING, ShortcutsActivator.PLUGIN_ID, clazz.getName() + ":" + message, e );
		log.log( status );
	}
	...
	public void error(Exception e, String message, Object... messageVariables) {
		...
		Status status =
		    new Status( IStatus.ERROR, ShortcutsActivator.PLUGIN_ID, clazz.getName() + ":" + message, e );
		log.log( status );
	}
